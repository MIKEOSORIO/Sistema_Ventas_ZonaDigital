...
namespace CapaPresentacion
{
    public partial class frmVistaArticulo_Venta : Form
    {
        ...
        private void dataListado_DoubleClick(object sender, EventArgs e)
        {
            ...
            string par1, par2, par3, par7, par8;
            decimal par4, par5;
            int par6;
            ...
            par7 = Convert.ToString(this.dataListado.CurrentRow.Cells["garantia_proveedor"].Value);
            par8 = Convert.ToString(this.dataListado.CurrentRow.Cells["garantia_tienda"].Value);
