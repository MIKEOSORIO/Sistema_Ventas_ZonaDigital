...
namespace CapaPresentacion
{
    public partial class frmProveedor : Form
    {
        ...
        {
            InitializeComponent();
            this.ttMensaje.SetToolTip(this.txtIdproveedor, "No agregar valores al campo");
            this.ttMensaje.SetToolTip(this.txtEmail, "Ingrese Email del proveedor");
            this.ttMensaje.SetToolTip(this.txtUrl, "Ingrese URL del proveedor");
            this.ttMensaje.SetToolTip(this.txtTelefono, "Ingrese Número de contacto del proveedor");
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                string rpta = "";
                if (this.txtRazon_Social.Text == string.Empty || this.txtDireccion.Text == string.Empty || this.txtTelefono.Text == string.Empty)
                {
