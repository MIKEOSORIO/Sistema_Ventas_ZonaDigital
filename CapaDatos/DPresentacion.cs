    ...
    public class DPresentacion
    {
        ...
        public string Insertar(DPresentacion Presentacion)
        {
            ...
            try
            {
                ...
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "No se ingreso el registro Correctamente";
        ...
        public string Editar(DPresentacion Presentacion)
        {
            ...
            try
            {
                ...
                //Ejecutamos el comando
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "No se actualizó el registro Correctamente";
        ...
        public string Eliminar(DPresentacion Presentacion)
        {
            ...
            try
            {
                ...
                //Ejecutamos el comando
                rpta = SqlCmd.ExecuteNonQuery() == 1 ? "OK" : "No se eliminó el registro Correctamente";
        ...
        public DataTable BuscarNombre(DPresentacion Presentacion)
        {
            ...
            try
            {
                ...
                SqlParameter PartTextoBuscar = new SqlParameter();
                PartTextoBuscar.ParameterName = "@textobuscar";
                PartTextoBuscar.SqlDbType = SqlDbType.VarChar;
                PartTextoBuscar.Size = 50;
                PartTextoBuscar.Value = Presentacion.TextoBuscar;
                SqlCmd.Parameters.Add(PartTextoBuscar);
