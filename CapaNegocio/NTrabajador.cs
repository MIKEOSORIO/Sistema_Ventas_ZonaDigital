...
namespace CapaNegocio
{
    public class NTrabajador
    {
        ...
        public static string Insertar(string nombre, string apellidos, string sexo,
            ...
            string direccion, string telefono, string num_agente ,string email, string acceso,
        ...
        public static string Editar(int idtrabajador, string nombre, string apellidos,
            string sexo,
            DateTime fecha_nacimiento, string num_documento,
            string direccion, string telefono, string email, string num_agente, string acceso, string usuario,
            string password)
        {
            DTrabajador Obj = new DTrabajador();
        ...
        public static DataTable BuscarNum_Agente(string textobuscar)
        {
            DTrabajador Obj = new DTrabajador();
            Obj.TextoBuscar = textobuscar;
            return Obj.BuscarNum_Agente(Obj);
        }
